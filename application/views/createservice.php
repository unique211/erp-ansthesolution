				...
				<input type="hidden" name="userid" id="userid" value="<?php echo $this->session->userdata('id'); ?>"/>
					...
					<div class="form-group row">
						...
						<div class="form-group row">
		                    ...
		                    <div class="col-sm-9">
		                        <input style="text-align:right;" type="number" class="form-control" id="amount" placeholder="Amount" required>
		                    </div>
	                    </div>
...
<script src="<?php echo base_url(); ?>dist/js/createservice.js"></script>
