				...
				<form id="mainform" method="post" class="form-horizontal">
                    ...
                    <div class="col-md-12" style="float:left;">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <option value="Cash">by chase</option>
                    ...
                    <div class="col-md-12" style="float:left">
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input type="text" required style="text-align:right"  class="form-control" id="amount" placeholder="Amount">
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="col-md-12" style="float:left;">
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input style="text-align:right" type="text" disabled required class="form-control" id="total_balance" placeholder="Total Balance">
                            </div>
                            <input type="hidden" id="getamttotal" value="">
                        </div>
                    </div>
