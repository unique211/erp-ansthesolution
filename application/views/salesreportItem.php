            ...
            <div class="col-12 d-flex no-block align-items-center" style="border:0px solid black;height:100px;background-color:white;">
                <div class="ml-left text-left">
                    ...
                    <div style="border:0px solid black;float:left;margin-left:5px;">
                        ...
                        <h6>Total Sales Report(Item Wise)</h6>
                    </div>
                </div>    
				...
				<div class="card-body">
                    <div class="row col-sm-12">
                        <div class="form-group col-md-3">
		                    <label  for="from_date">Select Item</label>
		                   <select name="name" class="form-control item_name" id="name"></select>
		                </div> 
		                <div class="form-group col-md-3">
...
<script src="<?php echo base_url(); ?>dist/js/salesreportItem.js"></script>
