$(document).ready(function() {
    ...
    function allbillshow() {
                ...
                if (data.length > 0) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        table += '<tr  id="' + data[i].id + '">' +
                            ...
                            '<td  style="text-align:right;" id="amount_' + data[i].id + '">' + data[i].distributor + '</td>' +
        ...
        $('#myTable tr').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: base_url + "Billreport/get_billdescription",
                data: {
                    table_name: 'bill_master',
                    id: cid,
                },
                ...
                success: function(data1) {
                    ...
                    if (data1.length > 0) {
                        ...
                        table1 += '<table id="myTable1" class="table table-striped" style="width:100%;">' +
                            ...
                            '<th style="white-space:nowrap;text-align:left;padding:10px;">Qty</th>' +
                            '<th style="white-space:nowrap;text-align:left;padding:10px;">Amount</th>' +
                            '<th style="white-space:nowrap;text-align:left;padding:10px;">Total Amount	</th>' +
                            '<th style="white-space:nowrap;text-align:left;padding:10px;">PaidAmount</th>' +
                            '<th style="white-space:nowrap;text-align:left;padding:10px;">Remain Amount</th>' +
                            '</tr>' +
                            '</thead>' +
                            '<tbody>';
                        var totalbillingamt = 0;
                        ...
                        for (var i = 0; i < data1.length; i++) {
                            console.log("for qty" + data1[i].qty + "for amt" + data1[i].amt + "total amt" + data1[i].totalamt + "for paid amt" + data1[i].paidamt + "for remain" + data1[i].remainamt);

                            table1 += '<tr id="myid_' + cid + '" class="myclass_' + cid + ' data" >' +
                                '<td>' + sr + '</td>' +
        ...
        //alert(iTableCounter+"detailsTableHtml"+detailsTableHtml);
        ...
        $('#myTable tbody td img').on('click', function() {
            ...
            console.log(colsetb);
            console.log(nTr);
            /* if("#myTable tbody td img"=="http://i.imgur.com/SD7Dz.png"){
                 echo 
             }*/
