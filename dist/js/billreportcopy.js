$(document).ready(function(){
  ...
  /*---------- Start For Getting branch In to Dropdown--------*/  
    ...
    function getMasterSelect(table_name,selecter,where){
        ...
        $.ajax({
           type : "POST",
           url  : base_url+"Billreport/getdropdown",
                ...
                success: function(data){
                  ...
                  //  $('#tablebody').html('');
                    ...
                    for(var i=0;i<data.length;i++)
                    {
                        ...
                        '<td  id="totalpaidamt_'+data[i].id+'">'+data[i].distributorname+'</td>'+
                        '</tr>' ;
                        index+=1;
                    }
                    table += '</tbody></table>';
                ...
                success: function(data){
                  ...
                  //  $('#tablebody').html('');
                    ...
                    for(var i=0;i<data.length;i++)
                    {
                        ...
                        '<td   id="branch_id_'+data[i].id+'">'+data[i].grandamt+'</td>'+

                        '<td  id="qty_'+data[i].id+'">'+data[i].totalpaidamt+'</td>'+
                           ...
                           if(data1.length >0){
                            ...
                            for(var i=0;i<data1.length;i++)
                            {
                                ...
                                '<td  style="display:none;" id="serviceid'+data1[i].id+'">'+data1[i].serviceid+'</td>'+
                                 '<td  id="qty_'+data1[i].id+'">'+data1[i].qty+'</td>'+
                                '<td  id="totalpaidamt_'+data1[i].id+'">'+data1[i].amt+'</td>'+
                                '<td id="amount_'+data1[i].id+'">'+data1[i].totalamt+'</td>'+
                                '<td id="amount_'+data1[i].id+'">'+data1[i].paidamt+'</td>'+
                                '<td  id="date_'+data1[i].id+'">'+data1[i].remainamt+'</td>'+
                              '</tr>' ;
                                sr+=1;
